...
@section('content')
    ...
    @else
        ...
        <div class="container  input-group mb-3 w-50">
            ...
            <input type="text" class="form-control "  value=" {{ Auth::user()->api_token }}"  disabled>
            <a class="btn btn-info" href="{{route('update')}}">Обновить</a>
        </div>

        <div class=" container w-50 card-body">
            <form method="POST" action="{{route('zapros')}}">
                @csrf
                <div class="mb-3">
